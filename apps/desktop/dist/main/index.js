...
var require_httpExecutor = __commonJS({
  "node_modules/electron-updater/node_modules/builder-util-runtime/out/httpExecutor.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.safeStringifyJson = exports2.configureRequestOptions = exports2.safeGetHeader = exports2.DigestTransform = exports2.configureRequestUrl = exports2.configureRequestOptionsFromUrl = exports2.HttpExecutor = exports2.parseJson = exports2.HttpError = exports2.createHttpError = void 0;
...
var require_publishOptions = __commonJS({
  "node_modules/electron-updater/node_modules/builder-util-runtime/out/publishOptions.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getS3LikeProviderBaseUrl = exports2.githubUrl = void 0;
...
var require_xml = __commonJS({
  "node_modules/electron-updater/node_modules/builder-util-runtime/out/xml.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.parseXml = exports2.XElement = void 0;
    var sax = require_sax();
    var index_1 = require_out();
    var XElement = class {
      constructor(name) {
...
var require_DownloadedUpdateHelper = __commonJS({
  "node_modules/electron-updater/out/DownloadedUpdateHelper.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.createTempUpdateFile = exports2.DownloadedUpdateHelper = void 0;
    var crypto_1 = require("crypto");
    var fs_1 = require("fs");
...
var require_AppAdapter = __commonJS({
  "node_modules/electron-updater/out/AppAdapter.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getAppCacheDir = void 0;
    var path = require("path");
    var os_1 = require("os");
...
var require_util = __commonJS({
  "node_modules/electron-updater/out/util.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.blockmapFiles = exports2.getChannelFilename = exports2.newUrlFromBase = exports2.newBaseUrl = void 0;
    var url_1 = require("url");
...
var require_Provider = __commonJS({
  "node_modules/electron-updater/out/providers/Provider.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.resolveFiles = exports2.getFileList = exports2.parseUpdateInfo = exports2.findFile = exports2.Provider = void 0;
    var builder_util_runtime_1 = require_out();
...
var require_GitHubProvider = __commonJS({
  "node_modules/electron-updater/out/providers/GitHubProvider.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.computeReleaseNotes = exports2.GitHubProvider = exports2.BaseGitHubProvider = void 0;
    var builder_util_runtime_1 = require_out();
...
var require_providerFactory = __commonJS({
  "node_modules/electron-updater/out/providerFactory.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.createClient = exports2.isUrlProbablySupportMultiRangeRequests = void 0;
    var builder_util_runtime_1 = require_out();
...
var require_DataSplitter = __commonJS({
  "node_modules/electron-updater/out/differentialDownloader/DataSplitter.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.DataSplitter = exports2.copyData = void 0;
    var builder_util_runtime_1 = require_out();
    var fs_1 = require("fs");
    var stream_1 = require("stream");
...
var require_multipleRangeDownloader = __commonJS({
  "node_modules/electron-updater/out/differentialDownloader/multipleRangeDownloader.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.checkIsRangesSupported = exports2.executeTasksUsingMultipleRangeRequests = void 0;
    var builder_util_runtime_1 = require_out();
...
var AiRouter = class {
  constructor(configs) {
    this.providers = configs.map((c) => createProvider(c)).filter(Boolean);
  }
  async *ask(params) {
...
var Storage = class {
  constructor() {
    ...
    const file = (0, import_path.join)(dir, "history.db");
  ...
  listSessions() {
    ...
    return rows.map((r) => ({ id: r.id, name: r.name, createdAt: r.created_at || 0, pinned: !!r.pinned, messages: this.listMessages(r.id) }));
  }
  listMessages(sessionId) {
    ...
    return rows.map((r) => ({ role: r.role, content: r.content, ts: r.ts, pinned: !!r.pinned }));
  }
  saveSession(sessionId, messages, name) {
    const now = Date.now();
...
function createWindow() {
  win = new import_electron2.BrowserWindow({
    ...
    webPreferences: {
      ...
      preload: (0, import_path2.join)(__dirname, "../preload/index.js")
    }
  });
  win.loadFile((0, import_path2.join)(__dirname, "../renderer/index.html"));
}
...
import_electron2.ipcMain.handle(IPC_AI_ASK, async (event, req) => {
...
var SettingsStore = class {
  constructor() {
    ...
    this.file = (0, import_path2.join)(dir, "settings.json");
    try {
      if ((0, import_fs.existsSync)(this.file)) {
        const raw = (0, import_fs.readFileSync)(this.file, "utf-8");
  ...
  set(s) {
    this.data = s;
    try {
      (0, import_fs.writeFileSync)(this.file, JSON.stringify(s, null, 2));
    } catch {
    }
  }
};
var settingsStore = new SettingsStore();
function buildProviderConfigs(s) {
...
import_electron2.ipcMain.handle(IPC_HISTORY_LIST, async () => {
  return { id: "list", ok: true, data: { sessions: storage.listSessions() } };
});
import_electron2.ipcMain.handle(IPC_HISTORY_SAVE, async (_e, req) => {
  try {
...
import_electron2.ipcMain.handle(IPC_HISTORY_DELETE_SESSION, async (_e, req) => {
  try {
...
import_electron2.ipcMain.handle(IPC_HISTORY_RENAME_SESSION, async (_e, req) => {
  try {
...
import_electron2.ipcMain.handle(IPC_HISTORY_PIN_SESSION, async (_e, req) => {
  try {
...
import_electron2.ipcMain.handle(IPC_AI_STOP, async (_e, req) => {
  const c = controllers.get(req.id);
  if (c) c.abort();
  controllers.delete(req.id);
  return { id: req.id, ok: true, data: null };
});
import_electron2.ipcMain.handle(IPC_UPDATE_INSTALL, async () => {
  import_electron_updater.autoUpdater.quitAndInstall();
  return { id: "install", ok: true, data: null };
});
import_electron2.ipcMain.handle(IPC_SETTINGS_GET, async () => {
  return { id: "get", ok: true, data: settingsStore.get() };
});
import_electron2.ipcMain.handle(IPC_SETTINGS_SET, async (_e, req) => {
  settingsStore.set(req.payload);
  return { id: req.id, ok: true, data: null };
});
import_electron2.ipcMain.handle(IPC_SEARCH_MESSAGES, async (_e, req) => {
  const hits = storage.searchMessages(req.payload.q, req.payload.limit || 20);
